...
#define CONFIG_POWER_LC709203F		1
#define CONFIG_POWER_BQ24160		1
#define CONFIG_POWER_MA01		1
#define MA01_BATTERY_FG			"LC709203F_FG"
#define MA01_BATTERY_CHRG		"BQ24160_CHRG"
#define MA01_BATTERY			"MA01_BATTERY"
...
#define CONFIG_ARMV8
#define CONFIG_ARM64_ERRATUM_836870
...
#define CONFIG_BOOTARGS                 \
		...
		" crashkernel=4k@0x8140000 androidboot.lcd=WXGA user_debug=31" \
		" earlyprintk=uart8250-32bit,0xd4018000"

#define CONFIG_BOOTCOMMAND	"mrvlboot"
#define CONFIG_MMC_BOOT_DEV     get_mmc_boot_dev()
#define RAMDISK_LOADADDR        (CONFIG_TZ_HYPERVISOR_SIZE + 0x02000000)
#define BOOTIMG_EMMC_ADDR_SD    0x04000000
#define BOOTIMG_EMMC_ADDR       0x05000000
#define RECOVERYIMG_EMMC_ADDR   0x00600000
...
#define CONFIG_SYS_MMC_ENV_DEV	get_mmc_env_dev()
#define CONFIG_CMD_SAVEENV
/* The begin addr where to save u-boot.bin in the eMMC/Nand */
#define CONFIG_UBOOT_PA_START	0x3F00000
...
#define CONFIG_VIDEO_VX5B1D

#define CONFIG_SERIAL_OFFSET	0x00400000
#define CONFIG_SERIAL_SIZE	512
#define CONFIG_EMMC_DEV		0

#define CONFIG_BATTERY_GUARD_SOC      7
