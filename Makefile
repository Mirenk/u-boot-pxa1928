...
$(obj)u-boot.srec:	$(obj)u-boot
		@echo "  OBJCOPY $(subst $(OBJTREE)/,,$@)"
		$(Q)$(OBJCOPY) ${OBJCFLAGS} -O srec $< $@
...
$(obj)include/autoconf.mk.dep: $(obj)include/config.h include/common.h
	@echo "  GEN     $(subst $(OBJTREE)/,,$@)"
	$(Q)$(CC) -x c -DDO_DEPS_ONLY -M $(CFLAGS) $(CPPFLAGS) \
		-MQ $(obj)include/autoconf.mk include/common.h > $@ || \
		rm $@

$(obj)include/autoconf.mk: $(obj)include/config.h
	@echo "  GEN     $(subst $(OBJTREE)/,,$@)"
	$(Q)$(CPP) $(CFLAGS) -DDO_DEPS_ONLY -dM include/common.h > $@.tmp && \
...
$(obj)include/tpl-autoconf.mk: $(obj)include/config.h
	@echo "  GEN     $(subst $(OBJTREE)/,,$@)"
	$(Q)$(CPP) $(CFLAGS) -DCONFIG_TPL_BUILD  -DCONFIG_SPL_BUILD\
...
$(obj)include/spl-autoconf.mk: $(obj)include/config.h
	@echo "  GEN     $(subst $(OBJTREE)/,,$@)"
	$(Q)$(CPP) $(CFLAGS) -DCONFIG_SPL_BUILD -DDO_DEPS_ONLY -dM include/common.h > $@.tmp && \
		sed -n -f tools/scripts/define2mk.sed $@.tmp > $@; \
	rm $@.tmp

$(obj)include/generated/generic-asm-offsets.h: $(obj)lib/asm-offsets.s
	@echo "  GEN     $(subst $(OBJTREE)/,,$@)"
	$(Q)tools/scripts/make-asm-offsets $(obj)lib/asm-offsets.s $@
...
$(obj)include/generated/asm-offsets.h: $(obj)$(CPUDIR)/$(SOC)/asm-offsets.s
	@echo "  GEN     $(subst $(OBJTREE)/,,$@)"
	$(Q)tools/scripts/make-asm-offsets $(obj)$(CPUDIR)/$(SOC)/asm-offsets.s $@
